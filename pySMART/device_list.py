    ...
    def _initialize(self):
        ...
        for line in _stdout.split('\n'):
            if not ('failed:' in line or line == ''):
                ...
                # hack for megaraid
                megaraid_disk = line.split(' ')[5]
                if "megaraid_disk" in megaraid_disk:
                    megaraid_number = int(re.sub('[^0-9]', '', megaraid_disk))
                    self.devices.append(Device(name, megaraid_number=megaraid_number))
